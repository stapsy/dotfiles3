...
let s:yellow = [ '#yellow', 11]
let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}
let s:p.normal.left = [ [ s:base03, s:base1 ], [ s:base1, s:base02 ] ]
let s:p.normal.right = [ [ s:base03, s:base0 ], [ s:base1, s:base01 ] ]
let s:p.inactive.right = [ [ s:base023, s:base01 ], [ s:base00, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base1, s:base02 ], [ s:base1, s:base02 ] ]
let s:p.insert.left = [ [ s:base02, s:yellow ], [ s:base1, s:base02 ] ]
let s:p.replace.left = [ [ s:base023, s:red ], [ s:base1, s:base01 ] ]
